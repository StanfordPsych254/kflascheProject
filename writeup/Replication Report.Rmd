...
```{r PrelimAnalysis, message=FALSE, warning=FALSE}
#Full dataframe
...
#Risk-taking
qplot(risk, data = d.gathered, binwidth=1) + theme_bw() + xlim(0,7)
#Is there an effect of condition on risk-taking?
qplot(risk, data = d.gathered, facets=~condition, binwidth=1) + theme_bw() + xlim(0,7)
...
#Visualize: Histograms
#Risk-taking
qplot(risk, data = d.gathered.time, binwidth=1) + theme_bw() + xlim(0,7)
#Is there an effect of condition on risk-taking?
qplot(risk, data = d.gathered.time, facets=~condition, binwidth=1) + theme_bw() + xlim(0,7)
#Does scenario moderate the effect of condition on risk-taking?
...
```{r Mediation_Visualize, warning=FALSE, message=FALSE}
#Visualize

#Full dataframe
#Histograms
#Risk
qplot(riskindex, data = d, binwidth=1) + theme_bw() + xlim(0,7)
#Risk by Condition
qplot(riskindex, data = d, facets=~condition, binwidth=1) + theme_bw() + xlim(0,7)
#Pereived Risk
qplot(perceivedriskindex, data = d, binwidth=1) + theme_bw() + xlim(0,7)
#Perceived Risk by Condition
qplot(perceivedriskindex, data = d, facets=~condition, binwidth=1) + theme_bw() + xlim(0,7)
...
#Histograms
#Risk
qplot(riskindex, data = d.time, binwidth=1) + theme_bw() + xlim(0,7)
#Risk by Condition
qplot(riskindex, data = d.time, facets=~condition, binwidth=1) + theme_bw() + xlim(0,7)
#Pereived Risk
qplot(perceivedriskindex, data = d.time, binwidth=1) + theme_bw() + xlim(0,7)
#Perceived Risk by Condition
qplot(perceivedriskindex, data = d.time, facets=~condition, binwidth=1) + theme_bw() + xlim(0,7)
...
```{r Mediation_Analysis_Sobelfunction, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r Mediation_Analysis, warning=FALSE, message=FALSE}
#Mediation Analysis
...
```{r Mediation_EachScenario, message=FALSE, warning=FALSE}
#Full Dataframe
...
```{r Mediation_EachPRItem, message=FALSE, warning=FALSE}
#Full Dataframe
#Likelihood
#Sobel
