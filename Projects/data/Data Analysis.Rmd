...
for (f in files) {
  ...
  id <- data.frame(workerid = jd$WorkerId,
                   timer = jd$answers$primetime,
                   god_condition = jd$answers$condition_god,
                   god_thoughts = jd$answers$god_thoughts,
                   god_attncheck = jd$answers$god_attncheck,
                   control_condition = jd$answers$condition_control,
                   control_thoughts = jd$answers$control_thoughts,
                   control_attncheck = jd$answers$control_attncheck)
...
#Everything below still comes from Mike's class6b file
Data cleanup
